...
namespace TinyFox.WebSocket
{
    ...
    public sealed class WebSocket
    {
        ...
        {
            // 检查是否是websocket请求
            if (!owinEnv.IsWebSocket()) throw new Exception("Not Is WebSocket Request.");
        ...
        internal bool Accept(IDictionary<string, object> param = null)
        {
        ...
        {
            SendTextBytes(Encoding.UTF8.GetBytes(message));
        }
    ...
    internal static class DictionaryExtensions
    {
        ...
        {
            return dictionary.TryGetValue(key, out object value) ? (T)value : default(T);
        }
